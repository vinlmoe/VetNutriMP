...
public IndicationP( MainNutrientEnum mne, String Name, int k,String q,boolean p, UnitP unit  ) {
...
public IndicationP( MainNutrientEnum mne, String Name, int k, String q, boolean p,UnitEnum unit  ) {
