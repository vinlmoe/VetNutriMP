...
suspend fun adjustRationByConstraints(
        ...
        try {
                ...
                // Contrainte optionnelle : une part minimale de l'énergie totale doit provenir des
                // aliments complets (FoodKind.COMPLET). Les autres aliments (complémentaires, bruts,
                // BARF...) complètent librement le reste, sous réserve des autres contraintes MIN/MAX.
