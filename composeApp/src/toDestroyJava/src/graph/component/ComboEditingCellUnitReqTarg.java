...
public class ComboEditingCellUnitReqTarg extends TableCell<TargetDefinitionEv, UnitReqEnum> {
	
    private ComboBox<UnitReqEnum> comboBox;

    public ComboEditingCellUnitReqTarg() {
   ...
   @Override
    ...
    private void createComboBox() {
    	 ObservableList<UnitReqEnum> targetData     = FXCollections.observableArrayList();
    				 ...
    				 targetData.add(UnitReqEnum.PERC);
...
comboBox.setValue(getTarget());
    ...
    private UnitReqEnum getTarget() {
        return getItem() == null ?  UnitReqEnum.PERC : getItem();
    }
}