...
public class FloatEditingCellNutrientRef extends TableCell<NutrientRefP, String> {
    ...
    public FloatEditingCellNutrientRef() {
	...
	public void commitEdit(String item) {
	    ...
	    if (!isEditing() && !item.equals(getItem())) {
	        TableView<NutrientRefP> table = getTableView();
	        if (table != null) {
	            TableColumn<NutrientRefP, String> column = getTableColumn();
	            CellEditEvent<NutrientRefP, String> event = new CellEditEvent<>(
	                table, new TablePosition<NutrientRefP,String>(table, getIndex(), column), 
