...
# Script de compilation iOS RELEASE-like avec optimisations DEBUG
# Utilise les paramètres qui fonctionnent en DEBUG mais pour une release

echo "🚀 COMPILATION iOS RELEASE-LIKE - VERSION STABLE"
echo "==============================================="
...
# Étape 2: Configuration mémoire optimisée (comme DEBUG qui fonctionne)
...
# Étape 3: Compilation iOS avec paramètres qui fonctionnent
echo "📱 Étape 3: Compilation iOS RELEASE-like..."

# Utiliser les mêmes paramètres que DEBUG mais avec linkReleaseFrameworkIosArm64
...
if [ -d "composeApp/build/bin/iosArm64/releaseFramework" ]; then
    ...
    echo ""
    echo "🎉 COMPILATION RELEASE-LIKE RÉUSSIE !"
    ...
    echo "✅ Ce framework utilise les optimisations qui fonctionnent en DEBUG."
...
echo ""
echo "✅ Script de compilation iOS RELEASE-like terminé avec succès !"
